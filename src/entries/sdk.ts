...
function addOneSignalPageES6SDKStub(): void {
  ...
  // 3. Stub out all functions but save calls into push(...), OneSignalPageSDKES6.js will load soon.
...
function addOneSignalPageES5SDKStub(): void {
...
function OneSignalShimMain(): void {
  if (isServiceWorkerRuntime()) {
    ...
    addOneSignalPageES6SDKStub();
  }
  else {
    addOneSignalPageES5SDKStub();
    // TODO: Move this to a new class to make sure this is all working!
    // TODO: Also test for if .push!
  }
}
