import { AppUserConfig, SlidedownOptionsVersion1 } from "../../src/models/AppConfig";
import { AppUserConfigPromptOptions, DelayedPromptType, SlidedownOptions } from "../../src/models/Prompts";
