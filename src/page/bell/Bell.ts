...
export default class Bell {
  ...
  private installEventHooks() {
    // Install event hooks
    OneSignal._emitter._on(Bell.EVENTS.SUBSCRIBE_CLICK, () => {
    ...
    OneSignal._emitter._on(Bell.EVENTS.UNSUBSCRIBE_CLICK, () => {
    ...
    OneSignal._emitter._on(Bell.EVENTS.HOVERING, () => {
      this.hovering = true;
    ...
    OneSignal._emitter._on(Bell.EVENTS.HOVERED, () => {
    ...
    OneSignal._emitter._on(Bell.EVENTS.STATE_CHANGED, (state) => {
