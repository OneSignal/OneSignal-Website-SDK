...
export class SlidedownManager {
  ...
  private async _checkIfSlidedownShouldBeShown(options: AutoPromptOptions): Promise<boolean> {
    ...
    if (_isSlidedownPushDependent) {
      if (subscribed) {
        ...
        Log._info(new Error('Already subscribed'));
        return false;
      }
  ...
  private async _mountTaggingContainer(options: AutoPromptOptions): Promise<void> {
    ...
    try {
      ...
      Log._error('Failed to create tagging container', e);
    }
  }
  ...
  private async _mountChannelCaptureContainer(options: AutoPromptOptions): Promise<void> {
    ...
    try {
      ...
      Log._error('Failed to create channel capture container', e);
    }
  }
  ...
  public async _handleAllowClick(): Promise<void> {
    ...
    try {
      ...
      Log._warn('Slidedown failed to update:', e);
  ...
  public async _createSlidedown(options: AutoPromptOptions): Promise<void> {
    ...
    try {
      ...
      Log._warn('Slidedown check error', e);
      return;
    }
