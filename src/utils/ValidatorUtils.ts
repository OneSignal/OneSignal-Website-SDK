...
export class ValidatorUtils {
  ...
  static isValidBoolean(bool: any, options?: ValidatorOptions) {
    if (options && options.allowNull && bool === null) return true;
    else return bool === true || bool === false;
  }

  static isValidArray(array: any, options?: ValidatorOptions) {
    if (options && options.allowNull && array === null) return true;
    else if (
      options &&
      options.allowEmpty &&
      ...
      return true;
    else return array instanceof Array;
  }
}
