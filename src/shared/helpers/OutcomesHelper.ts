  ...
  async send(outcomeProps: OutcomeProps): Promise<void> {
    ...
    switch (type) {
      case OutcomeAttributionType.Direct:
        ...
        await OneSignal._context._updateManager.sendOutcomeDirect(
          this.appId,
          notificationIds,
          this.outcomeName,
          weight,
      ...
      case OutcomeAttributionType.Indirect:
        ...
        await OneSignal._context._updateManager.sendOutcomeInfluenced(
          this.appId,
          notificationIds,
          this.outcomeName,
          weight,
      ...
      case OutcomeAttributionType.Unattributed:
        ...
        await OneSignal._context._updateManager.sendOutcomeUnattributed(
          this.appId,
          this.outcomeName,
          weight,
        );
