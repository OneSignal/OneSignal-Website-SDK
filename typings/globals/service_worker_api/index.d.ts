...
// Source: https://raw.githubusercontent.com/jasonpang/DefinitelyTyped/2395bb1890c366ae338087561b60b1a68267a815/service_worker_api/service_worker_api.d.ts
interface Body {
    /**
...
interface ServiceWorkerClients {
     ...
     *
     * @param id A DOMString representing the id of the client you want to get.
     */
    get(id: String): Promise<ServiceWorkerClient>;
...
/**
 * The PushSubscriptionOptions interface provides an object containing
...
interface PushSubscriptionOptions {
    ...
    /**
      * A public key your push server will use to send messages to client apps via 
      * a push server. This value is part of a signing key pair generated by your 
      * application server and usable with elliptic curve digital signature (ECDSA) 
...
interface PushSubscription {
    ...
    /**
     * Returns an ArrayBuffer representing a client public key, which can then be sent
     * to a server and used in encrypting push message data.
     * @readonly
     *
     * @param string: The encryption method used to generate the client public key.
     *                 p256dh and auth are currently the only options.
     */
    getKey(key: string): ArrayBuffer;

    /**
     * Returns a JSON representation of the subscription properties
     * @readonly
     */
    toJSON(): JSON;

    /**
     * Returns a Promise that resolves to a Boolean when the current subscription is 
...
interface ServiceWorkerRegistration extends EventTarget {
     ...
     */
    showNotification(title: string, options: any): Promise<NotificationEvent>;
