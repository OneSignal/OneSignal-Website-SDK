...
interface OneSignalNotifications {
  ...
  addEventListener<K extends keyof NotificationEventMap>(event: K, listener: (event: NotificationEventMap[K]) => void): void;
  isPushSupported(): boolean;
  removeEventListener<K extends keyof NotificationEventMap>(event: K, listener: (event: NotificationEventMap[K]) => void): void;
