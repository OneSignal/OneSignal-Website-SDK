...
export interface NockScopeWithResultPromisePlayerPost
  extends NockScopeWithResultPromise {
  result: Promise<NockRequestResultPayerPost>;
}

export class NockOneSignalHelper {
  static nockNotificationPut(
  ...
  static nockNotificationConfirmedDelivery(
    notificationId?: string,
  ): NockScopeWithResultPromise {
    return NockHelper.nockBase({
      method: 'put',
